...
> :warning: This repo is still a work in progress - the underlying RandomBeaconHistory smart contract is also still a work in progress
...
the protection of a commit-reveal mechanism would enable callers to condition their interactions with your contract on the
